...
<main>
    <section class="banner">
        ...
        <a href="quienes-somos.php" class="btm-banner" >CONTACTO</a>
    </section>
...
<!-- Contenedor del video emergente -->
<div class="video-popup" id="videoPopup">
    <!-- Botón de cierre -->
    <button class="close-btn" onclick="closeVideo()">×</button>
    <!-- Iframe del video -->
    <iframe src="https://www.youtube.com/embed/rjA9qYBNzLE?autoplay=1" allow="autoplay" allowfullscreen></iframe>
</div>
